...
class Seq2SeqAttNN(NN):
    ...
    def __init__(self, config):
        ...
        if config != None:
            ...
            self.pre_tag = []
            for i in range(len(self.pre_embedding)):
    ...
    def build_model(self):
        ...
        self.embe_new_dict= tf.concat((self.embe_dict,embe_dict_all_tag),axis=-1)

        

        sco_mat = tf.matmul(prod,self.embe_new_dict[1:],transpose_b= True)
